...
library(readxl)
sdm <- NULL
data <- read_excel("G:/My Drive/# REGISTRASI DAN STATISTIK/Website/212201/static/SDM_dosen_pns.xlsx")
sdm <- rbind(sdm, data)
data <- read_excel("G:/My Drive/# REGISTRASI DAN STATISTIK/Website/212201/static/SDM_dosen_non_pns.xlsx")
sdm <- rbind(sdm, data)
data <- read_excel("G:/My Drive/# REGISTRASI DAN STATISTIK/Website/212201/static/SDM_tendik_non_pns.xlsx")
sdm <- rbind(sdm, data)
